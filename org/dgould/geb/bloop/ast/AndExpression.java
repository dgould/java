...
public class AndExpression extends OperatorExpression
{
	...
	public AndExpression(Expression left, Expression right)
	{
		...
		this.debugStr = "AndExpression\n";
	}

	public void Print(java.io.PrintStream output, String indent)
	{
		output.println(indent + "AndExpression");
		...
		throws SemanticException
	{
		...
		{
			throw new SemanticException("non-numeric left operand to 'AND' operator");
		}
		if(!this.right.IsBoolean())
		{
			throw new SemanticException("non-numeric right operand to 'AND' operator");
		}
	}
	...
	public Value Evaluate() throws LogicException
	{
		...
		throw new LogicException("non-boolean operand to 'AND' operator");
	}
}
