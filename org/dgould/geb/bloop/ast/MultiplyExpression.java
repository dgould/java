...
public class MultiplyExpression extends OperatorExpression
{
	...
	public MultiplyExpression(Expression left, Expression right)
	{
		...
		this.debugStr = "MultiplyExpression\n";
	}

	public void Print(java.io.PrintStream output, String indent)
	{
		output.println(indent + "MultiplyExpression");
	...
	public Value Evaluate() throws LogicException
	{
		...
		if(v1 == null)
		{
			throw new LogicException("NULL left operand to Multiply expression");
		}
		if(v2 == null)
		{
			throw new LogicException("NULL right operand to Multiply expression");
		}
		
		if(v1.IsNumber() && v2.IsNumber())
		{
			return new Value(NaturalNumber.Multiply(v1.numberValue, v2.numberValue));
		}
